...
class AuthorsTest(AuthorsBaseTest):
    ...
    def test_passwords_do_not_match(self):
        def callback(form):
            ...
            password1.send_keys("P2ssw0rd")
            password2.send_keys("P2ssw0rd_Different")
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, "Your e-mail").send_keys("em@valid.com")
